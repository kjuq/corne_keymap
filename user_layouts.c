...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ORS] = LAYOUT_split_3x5_3_ex2( // {{{
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,  KC_LEFT,                           XXXXXXX, KC_ENT,  XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    [_ADJUST2] = LAYOUT_split_3x5_3_ex2( // {{{
        ...
        XXXXXXX, XXXXXXX, QWERTY,  COLEMAK, XXXXXXX, XXXXXXX,         XXXXXXX, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,XXXXXXX,
        XXXXXXX, XXXXXXX, KO_TOGG, EE_CLR,  XXXXXXX,                           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
